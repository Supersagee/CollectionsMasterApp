...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                Console.WriteLine("Give me a number between 1 and 50 to see if I have it in my list");
                isNumber = int.TryParse(Console.ReadLine(), out userNumber);
            } while (isNumber == false || userNumber > 50 || userNumber < 1);
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"Yup, we have number {searchNumber}! Good guess!");
            }
            else
            {
                Console.WriteLine($"{searchNumber} is not in the list of numbers!");
            }
